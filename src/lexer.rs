...
const SIMPLE_MATCH_STRINGS: [&str; 11] = [
    r"^\{", r"^\}", r"^\(", r"^\)", r"^;", r"^:=", r"^=", r"^,", r"^true", r"^false", r"^func",
];
const SIMPLE_MATCH_LENGTHS: [usize; 11] = [1, 1, 1, 1, 1, 2, 1, 1, 4, 5, 4];
const SIMPLE_MATCH_TOKENS: [Token; 11] = [
    Token::OpenBrace,
    Token::CloseBrace,
    Token::OpenParens,
    Token::CloseParens,
